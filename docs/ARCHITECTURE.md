...
| D1 | Users, sessions, projects, versions, encrypted keys, credits, usage, run history |
...
- Streaming provider output is not implemented.
...
- Billing, teams, RBAC, and audit trails are not active.
